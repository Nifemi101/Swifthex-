// ============================================================
// SwiftyEx TWA — App Root
// Initializes Telegram SDK, manages tab state,
// and renders the correct page based on active tab
// ============================================================
...
const MarketRates = () => (
  <div className="flex items-center justify-center h-full">
    <p style={{ color: '#9CA3AF' }}>Market Rates coming soon...</p>
  </div>
)

const SwapInterface = () => (
  <div className="flex items-center justify-center h-full">
    <p style={{ color: '#9CA3AF' }}>Swap coming soon...</p>
  </div>
)

const TransactionHistory = () => (
  <div className="flex items-center justify-center h-full">
    <p style={{ color: '#9CA3AF' }}>Transaction History coming soon...</p>
  </div>
)

const Profile = () => (
  <div className="flex items-center justify-center h-full">
    <p style={{ color: '#9CA3AF' }}>Profile coming soon...</p>
  </div>
)

// ============================================================
// Page renderer — returns the correct page for the active tab
// ============================================================
const renderPage = (tab: TabName) => {
  switch (tab) {
    case 'portfolio':  return <Portfolio />
    case 'rates':      return <MarketRates />
